...
export const OFFICIAL_MENU_ITEMS = [
    ...
    },
    {
        ...
        categoryId: 'cat_shawarma_wraps',
        price: 220,
        description: 'Crunchy golden zinger chicken strips wrapped in fresh pita with spicy garlic mayo sauce & shredded cabbage.',
        imageUrl: 'https://images.unsplash.com/photo-1561651823-34feb02250e4?w=600&q=80',
        available: true,
        inStock: true,
        stockLevel: 80,
    ...
    },
    {
        ...
        categoryId: 'cat_sides',
        price: 700,
        description: 'Fries loaded with tender charcoal-grilled chicken boti chunks, melted cheese, black olives, and BBQ drizzle.',
        imageUrl: 'https://images.unsplash.com/photo-1585109649139-366815a0d713?w=600&q=80',
        available: true,
        inStock: true,
        stockLevel: 60,
    ...
    // =========================================================================
    {
        ...
        variations: [
            ...
            { name: 'Extra Topping', options: ['No Extra Topping', 'Extra Topping Small (+Rs. 140)', 'Extra Topping Medium (+Rs. 190)', 'Extra Topping Large (+Rs. 270)', 'Extra Topping XL (+Rs. 350)'] }
        ]
    },
    {
        id: 'fb_pz_fajita',
        ...
        variations: [
            { name: 'Size', options: ['Small 7 inch (Rs. 450)', 'Medium 10 inch (Rs. 800)', 'Large 13 inch (Rs. 1200)', 'XL 17 inch (Rs. 1600)'] },
            { name: 'Extra Topping', options: ['No Extra Topping', 'Extra Topping (+Rs. 190)'] }
        ]
    },
    {
        id: 'fb_pz_supreme',
    ...
    // =========================================================================
    {
        ...
        price: 590,
        description: '1 Zinger Burger + 1 PC Chicken + 1 345ml Soft Drink.',
        imageUrl: 'https://images.unsplash.com/photo-1550547660-d9450f859349?w=600&q=80',
        available: true,
        inStock: true,
        stockLevel: 100,
    ...
    },
    {
        ...
        categoryId: 'cat_deals',
        price: 1140,
        description: '2 Zinger Burgers + 2 PC Chicken + 2 345ml Soft Drinks.',
        imageUrl: 'https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=600&q=80',
        available: true,
        inStock: true,
        stockLevel: 100,
