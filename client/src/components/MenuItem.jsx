...
const MenuItem = ({ item, onClick }) => {
    ...
    return (
        <div
            ...
            aria-label={`${name} - Rs. ${currentPrice}${hasDiscount ? ` (${badge})` : ''}${hasVariations ? ' (Customizable)' : ''}${!isAvailable ? ' (Out of stock)' : ''}`}
        ...
        >
            ...
            <div className="menu-item-badges">
                ...
                {isAvailable && hasDiscount && badge && (
                    <div className="discount-badge" title={discountTitle || 'Special Promotion'}>
                        🔥 {badge}
                    </div>
                )}
                {isAvailable && isSpicy && (
